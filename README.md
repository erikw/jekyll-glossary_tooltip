...
<figure style="float: right">
  <img align=src="/img/tooltip_screenshot.png" width="256" alt="Screenshot of the glossary tooltip term definition" title="Example of tooltip definition of the term 'Jekyll'.">
